...
class SpriteComponent: public Component {
	...
	public:
		...
		void Update(float deltaTime) override {
			...
			destinationRectangle.x = static_cast<int>(entityTransform->position.x) - (isFixed ? 0 : Game::camera.x);
			destinationRectangle.y = static_cast<int>(entityTransform->position.y) - (isFixed ? 0 : Game::camera.y);
